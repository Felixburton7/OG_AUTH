...
final class  LmsMembersDTO extends Equatable {
  ...
  factory LmsMembersDTO.fromJson(Map<String, dynamic> json) {
    return LmsMembersDTO(
  ...
  factory LmsMembersDTO.fromEntity(LmsPlayersEntity entity) {
    return LmsMembersDTO(
      playerId:
          entity.playerId, // Assuming playerId exists in LeagueMembersEntity
